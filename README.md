...
| DB1 存储版本 | 语义支持证据 |
|---|---|
| 7.30 | 已固定公开教学主库和组件库，沿用旧构件/几何路径；DB2的20个系列与21项编号历史计数核对，逐对象编号仍待恢复 |
...
`tests/corpus.json` 记录 645 个外部文件路径的固定来源 URL、大小、SHA-256 和 1,408 个用例。第三方模型不随仓库分发。需要 Python 3.11+：
